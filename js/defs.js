...
// PIECES.EMPTY rather than 0

const BOARD_SQUARE_NUM = 120; // No longer 64, to make it easier to control Knight and Bishop movement

const FILES = { FILE_A : 0, FILE_B : 1, FILE_C : 2, FILE_D : 3, FILE_E : 4,
                FILE_F : 5, FILE_G : 6, FILE_H : 7, FILE_NONE : 8};

const RANKS = { RANK_1 : 0, RANK_2 : 1, RANK_3 : 2, RANK_4 : 3, RANK_5 : 4,
                RANK_6 : 5, RANK_7 : 6, RANK_8 : 7, RANK_NONE : 8};

const COLOURS = { WHITE : 0, BLACK : 1, BOTH : 2}; // To flip side   side ^= 1

const CASTLEBIT = { WKCA : 1, WQCA: 2, BKCA: 4, BQCA: 8}; // We're going to castle through binary

const SQUARES = { A1: 21, B1: 22, C1: 23, D1: 24, E1: 25, F1: 26, G1: 27, H1: 28,
                A8: 91, B8: 92, C8: 93, D8: 94, E8: 95, F8: 96, G8: 97, H8: 98,
                NO_SQ: 99, OFF_BOARD: 100};

const MAXGAMEMOVE = 2048;
const MAXPOSITIONMOVES = 256;
const MAXDEPTH = 64;

var FilesBrd = new Array(BOARD_SQUARE_NUM);
var RanksBrd = new Array(BOARD_SQUARE_NUM);
...
const MFLAGEP = 0x40000; // Used for bitwise AND operation
const MFLAGPS = 0x80000; // Pawn Start
const MFLAGCA = 0x1000000; // Castling

const MFLAGCAP = 0x7C000; // Capture/En passant
const MFLAGPROM = 0xF00000; // Promotion
...
function FileRankToSquare(f,r) {
    return ((21 + f) + (r*10));    // We set A1 = 0, so +21 to get the the (playable) board, r * 10 to get row
}

// TODO: add look up ability
...
var PieceKeys = new Array(14 * 120); // Pce * 120 + sq [get unique index]
var SideKey;
var CastleKeys = new Array(16); // 1111 = 15 in binary
...
const Sq120To64 = new Array(BOARD_SQUARE_NUM);
...
function SQOFFBOARD(sq) {
    return (FilesBrd[sq] === SQUARES.OFF_BOARD);
}
